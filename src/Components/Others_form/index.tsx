    ...
    return (
        <div className="container">
            ...
            <div className="one">
                ...
                <div className="body">
                    <div className="picture"><img src={avatar == '' ? default_avatar : avatar} alt=""
            ...
            <div className="two">
                ...
                <div className="body">
                    <div className="row"><span> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;心动组别：</span><span
                        className='circle_two'>{group}</span></div>
                    <div className="row"><span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;心动理由：</span><span
                        className='circle_three'>{reason}</span></div>
                    <div className="row_1"><span>对组别的了解：</span><span className='circle_three'>{understand}</span>
                    </div>
                </div>
            </div>
            <div className="three">
                ...
                <div className="body">
                    <div className="intro"><span>自我介绍：</span><span
                        className='circle_three'>{self_introduction}</span></div>
                </div>
            </div>
            <div className="four">
                <div className="head">
